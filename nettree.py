...
def parse_nettree_tree(file_path):
...
def main():
    file_name = input("Enter the name of the .il language file to load: ")

    try:
        tree = parse_nettree_tree(file_name)
        print("\nParsed net il language Tree:")
        print(tree)
